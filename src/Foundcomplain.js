...
const Mappopup = (props) => {
  ...
  class Foundcomplain extends React.Component {
    ...
    toast("Dont refresh you will be migrated automatically");
         ...
         const response = await fetch("http://127.0.0.1:8000/foundperson/report",{
             method: "POST",
             headers: {
         ...
         {
          alert("As soon as Someone register missing complain of whom you found we will notify you via email ");
    ...
    <h2>Found Person Details</h2>
      ...
      <input type="file" name="photo" required  style={{margin:"8px"}}
         ...
         <p>Select exact location where you found
          Him/Her:</p>
